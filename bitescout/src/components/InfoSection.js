...
const InfoSection = () => {
    return (
        <div className="flex flex-col md:flex-row gap-4 h-auto">
            <div className="text-center mb-4 bg-cyan-200 mt-2 w-full md:w-1/3 p-4">
                <h1 className="font-semibold text-2xl mt-3 mb-2">Discover</h1>
                <p>
            ...
            <div className="text-center mb-4 bg-orange-200 mt-2 w-full md:w-1/3 p-4">
                <h1 className="font-semibold text-2xl mt-3 mb-2">Help us make food transparency the norm!</h1>
                <p>
                    Discover a wide variety of food products available for you. Find your favorites and explore new options!
                </p>
            </div>
            <div className="text-center mb-4 bg-cyan-200 mt-2 w-full md:w-1/3 p-4">
                <h1 className="font-semibold text-2xl mt-3 mb-2">Contribute</h1>
                <p>
